...
import com.tbst.kjd.config.ApplicationProperties
...
class KotlinJhipsterDemoApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes KotlinJhipsterDemo.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KotlinJhipsterDemoApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KotlinJhipsterDemoApp::class.java)
